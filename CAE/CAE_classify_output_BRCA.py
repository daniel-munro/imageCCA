...
weightsFile = 'CAE_classify_BRCA/discrim_weights_2999.h5' # trained network weights
outputFile  = 'CAE_classify_output_BRCA.csv' # name of file to save
imPath      = 'BRCA_images/' # path to images
nClasses = 2
